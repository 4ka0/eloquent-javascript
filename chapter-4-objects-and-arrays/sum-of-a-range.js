...
// return 55. As a bonus assignment, modify your range function to take an
// optional third argument that indicates the “step” value used when building
...
function range (start, end, givenStep) {
    let result = [];
    let step = 1;
    if (givenStep !== undefined) {
        step = givenStep;
    }
    if (step < 0) {
